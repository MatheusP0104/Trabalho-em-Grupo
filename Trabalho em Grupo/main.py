...
bt_cadas = Button(frame_login, text='Cadastrar', font='Cardo 12 underline', bg=dark_gray, fg=blue, activebackground=dark_gray, activeforeground=blue, bd=0,
...
bt_add_bibli = Button(frame_mario,text='Adicionar a Biblioteca',font='palatino 15 bold',bd=0,bg='#737373',fg=black,
                      activebackground='#737373',activeforeground=black, command=lambda: bt_mario_bibli.place(width=195,
                                                                                                              height=21,
                                                                                                              x=5,
                                                                                                              y=164))
...
bt_add_bibli = Button(frame_sonic,text='Adicionar a Biblioteca',font='palatino 15 bold',bd=0,bg='#737373',fg=black,
                      activebackground='#737373',activeforeground=black,command=lambda:bt_sonic_bibli.place(width=195,
                                                                                                              height=21,
                                                                                                              x=5,
                                                                                                            y=192))
bt_add_bibli.place(width=200, height=39, x=240, y=477)
...
bt_perfil.place(x=5, y=472)
bt_add_bibli = Button(frame_donkeykong,text='Adicionar a Biblioteca',font='palatino 15 bold',bd=0,bg='#737373',fg=black,
                      activebackground='#737373',activeforeground=black,command=lambda:bt_donkey_bibli.place(width=195,
                                                                                                              height=21,
                                                                                                              x=10, y=219))
bt_add_bibli.place(width=200, height=39, x=240, y=477)
#=======================================================================================================================
...
bt_perfil.place(x=5, y=472)
bt_add_bibli = Button(frame_bomberman,text='Adicionar a Biblioteca',font='palatino 15 bold',bd=0,bg='#737373',fg=black,
